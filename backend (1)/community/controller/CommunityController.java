...
public class CommunityController {
	...
	public ResponseEntity<Community> getPostById(@PathVariable int postId) {
		
		Community community = communityService.getCommunityPostById(postId);
		if (community != null) {
     ...
     */
	@PostMapping("/post")
	public ResponseEntity<String> createPost(HttpServletRequest request, @RequestParam("postTitle") String postTitle,
		...
		try {
			...
			community.setUserUniqueNumber(userUniqueNumber);
	...
	public ResponseEntity<String> updatePost(@PathVariable int postId, @RequestParam("postTitle") String postTitle,
			@RequestParam("postContent") String postContent, @RequestParam("categoryName") int categoryName,
			@RequestParam("userUniqueNumber") String userUniqueNumber,
			@RequestPart(value = "file", required = false) MultipartFile file) {
		...
		try {
			...
			communityService.updateCommunityPost(null, postId, community, file);
    ...
    public ResponseEntity<PostCommentStatsDto> getPostAndCommentStats(@PathVariable String userId) {
        PostCommentStatsDto stats = communityService.getPostAndCommentStatsByUserId(userId);
