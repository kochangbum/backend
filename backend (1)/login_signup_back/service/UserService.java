...
public class UserService {
	...
	// # 반환값 : 조회된 User 객체
	public User findByUniqueNumber(HttpServletRequest request) {
		...
		return user;  // 사용자가 null이 아닐 경우 반환  // MyBatis 쿼리 실행
	}
	...
	public UserDTO loginUser(String userId, String userPassword) {
		...
		throw new IllegalArgumentException("로그인 실패: 사용자 정보가 일치하지 않습니다.");
	}
